...
Page({
    ...
    previewImg: function (e) {
        // var imgUrls = this.data.bannerImgs;
    ...
    gotoDetail: function (e) {
        ...
        wx.navigateTo({
            url: '../productDetail/productDetail?id=' + orgnId + '&productTitle=tourism',
        });
    },
        ...
        util.HttpRequst(true, "ztc/banner/list", 1, wx.getStorageSync("sessionId"), {
            ...
            if (res.code == 200) {
                if (res.list.length > 0) {
                    ...
                    that.setData({ bannerImgs: ['../../img/cxyMallPage/defaultImg.png'] });
                }
    ...
    getDataList: function () {
        ...
        util.HttpRequst(true, "ztc/product/tourList", 1, wx.getStorageSync("sessionId"), {
